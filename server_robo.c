...
static const char *expected_initial_hash = "EXPECTED_INITIAL_HASH"; // Replace with your expected hash
static const char *expected_periodic_hash = "EXPECTED_PERIODIC_HASH"; // Replace with your expected hash
